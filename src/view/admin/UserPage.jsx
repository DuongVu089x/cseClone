...
class UserPage extends React.Component {
    ...
    create(e) {
        this.props.createUser(data => this.userModal.current.show(data.user));
        e.preventDefault();
    }
    ...
    render() {
        ...
        return (
            <main className='app-content'>
                ...
                <UserModal updateUser={this.props.updateUser} ref={this.userModal} />
