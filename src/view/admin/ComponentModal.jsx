...
export default class ComponentModal extends React.Component {
    constructor(props) {
        ...
        this.selectPageItem = this.selectPageItem.bind(this);
    ...
    show(parentId, item) {
        const { _id, className, style, viewId, viewType } = item ? item : { _id: null, className: 'row', style: '', viewId: null, viewType: '<empty>' };
    ...
    typeChanged(selectedType) {
        ...
        const types = [
            '<empty>',
            'last news',
            'subscribe', 'contact', 'all divisions',
            'all news',
        ];
    ...
    save() {
        const btnSave = $(this.btnSave.current),
            ...
            data = {
                viewType: this.viewType.current.getSelectedItem().toLowerCase(),
                    ...
                    <div className='modal-content'>
                        ...
                        <div className='modal-body'>
                            ...
                            <div className='form-group'>
                                ...
                                <small>Ví dụ: "marginTop": "50px"; "paddingBottom": "20px"</small>
                            </div>
                            <div className='form-group'>
